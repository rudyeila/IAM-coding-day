...
addToMapIfValueNotNull = { map, key, value ->
...
userAddressClaimResolver = { claim, identity ->
    if (identity != null) {
        street_address = fromSet(claim.getName(), identity.getAttribute("streetAddress"))
        locality = fromSet(claim.getName(), identity.getAttribute("localityName"))
        region = fromSet(claim.getName(), identity.getAttribute("stateOrProvinceName"))
        postal_code = fromSet(claim.getName(), identity.getAttribute("postalCode"))
        country = fromSet(claim.getName(), identity.getAttribute("country"))
            result = [:]
      
      addToMapIfValueNotNull(result, "street_address", street_address)
      addToMapIfValueNotNull(result, "locality", locality)
      addToMapIfValueNotNull(result, "region", region)
      addToMapIfValueNotNull(result, "postal_code", postal_code)
      addToMapIfValueNotNull(result, "country", country)
...
claimAttributes = [
        ...
        "given_name": userProfileClaimResolver.curry("firstName"),
        "family_name": userProfileClaimResolver.curry("lastName"),
        "hobbies": userProfileClaimResolver.curry("hobbies"),
        "customString": userProfileClaimResolver.curry("customString"),
        "customArray": userProfileClaimResolver.curry("customArray"),
        "localityName": userProfileClaimResolver.curry("localityName"),
        "stateOrProvinceName": userProfileClaimResolver.curry("stateOrProvinceName"),
        "postalCode": userProfileClaimResolver.curry("postalCode"),
        "country": userProfileClaimResolver.curry("country"),
        "postalCode": userProfileClaimResolver.curry("postalCode"),
        "birthday": userProfileClaimResolver.curry("birthday"),
        "gender": userProfileClaimResolver.curry("gender"),
        "job": userProfileClaimResolver.curry("job"),
        "healthFile": userProfileClaimResolver.curry("healthFile"),
        "customerSince": userProfileClaimResolver.curry("customerSince")
]
...
scopeClaimsMap = [
        "email": [ "email" ],
        "profile": [ "given_name", "family_name", "gender", "hobbies","birthday", "job"],
  		"address": ["localityName", "stateOrProvinceName", "postalCode", "country", "postalCode"],
  		"custom": ["customString", "customArray", "healthFile", "customerSince"]
]
